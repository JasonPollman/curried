import cloneDepthFx from '.';

describe('cloneDepthFx', () => {
  describe('Shallow cloning (default depth)', () => {
    it('Should be a function', () => {
      expect(typeof cloneDepthFx).toBe('function');
    });

    it('Should return literal values', () => {
      expect(cloneDepthFx(0)(undefined)).toBe(undefined);
      expect(cloneDepthFx(0)(null)).toBe(null);
      expect(cloneDepthFx(0)(1)).toBe(1);
      expect(cloneDepthFx(0)(0)).toBe(0);
      expect(cloneDepthFx(0)(-0)).toBe(-0);
      expect(cloneDepthFx(0)(-1)).toBe(-1);
      expect(cloneDepthFx(0)('foo')).toBe('foo');
      expect(cloneDepthFx(0)('')).toBe('');
      expect(cloneDepthFx(0)(Infinity)).toBe(Infinity);
      expect(cloneDepthFx(0)(-Infinity)).toBe(-Infinity);
      expect(cloneDepthFx(0)(NaN)).toBe(NaN);
    });

    it('Should clone plain objects', () => {
      const object = { foo: 'bar' };
      const cloned = cloneDepthFx(0)(object);
    ...
    it('Should default to cloning to depth 0 (1)', () => {
      ...
      const cloned = cloneDepthFx(0)(object, -1);
    ...
    it('Should clone Arrays', () => {
      const array = [1, 2, 3];
      const cloned = cloneDepthFx(0)(array);
    ...
    it('Should clone RegExp objects', () => {
      const regexp = /foo/gi;
      const cloned = cloneDepthFx(0)(regexp);
    ...
    it('Should clone Symbol objects (1)', () => {
      ...
      const cloned = cloneDepthFx(0)(symbol);
    ...
    it('Should clone Date objects (1)', () => {
      ...
      const cloned = cloneDepthFx(0)(date);
    ...
    it('Should clone Number objects (1)', () => {
      ...
      const cloned = cloneDepthFx(0)(source);
    ...
    it('Should clone Arguments objects', () => {
      (function testit() {
        const cloned = cloneDepthFx(0)(arguments);
  ...
  describe('Deep cloning (depth > 0)', () => {
    ...
    it('Should clone to the specified depth (1)', () => {
      ...
      const cloned = cloneDepthFx(1)(object);
    ...
    it('Should clone to the specified (depth 2, circular)', () => {
      ...
      const cloned = cloneDepthFx(2)(object);
    ...
    it('Should clone to the specified depth (Infinity)', () => {
      ...
      const cloned = cloneDepthFx(Infinity)(object);
    ...
    it('Should clone to the specified depth (NaN)', () => {
      ...
      const cloned = cloneDepthFx(NaN)(object);
    ...
    it('Should clone to the specified depth (array, depth 100)', () => {
      ...
      const cloned = cloneDepthFx(100)(object);
