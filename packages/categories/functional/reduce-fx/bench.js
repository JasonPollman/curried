module.exports = ({
  ...
  return [
    ...
    },
    {
      ...
      setup: () => [[1, 2, 3, 4, 5, 6], () => []],
      tests: {
        foldr: ([input, acc]) => foldr.reduce(input, double, acc()),
    ...
    },
    {
      ...
      setup: () => [[1, 2, 3, 4, 5, 6], () => []],
      tests: {
        foldr: ([input, acc]) => foldr.reduce.f(doubleFN, acc(), input),
